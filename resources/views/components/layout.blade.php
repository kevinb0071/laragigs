...
<head>
    ...
    <title>LaravelJobs | Find Laravel Jobs & Projects</title>
</head>

<body class="mb-48">
    <nav class="flex justify-between items-center mb-4">
        <a href="/"><img class="w-24" src="{{ asset('images/ljlogo.jpeg') }}" alt="" class="logo" /></a>
    ...
    <footer
        ...
        <a href="listings/create" class="absolute top-1/3 right-10 bg-red-800 text-white py-2 px-5">Post Job</a>
    </footer>
    <x-flash-message />
</body>
