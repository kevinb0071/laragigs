       ...
       <section class="relative h-72 bg-laravel flex flex-col justify-center align-center text-center space-y-4 mb-4">
           ...
           <div class="z-10">
               <h1 class="text-6xl font-bold uppercase text-white">
                   Laravel<span class="text-red-700">Jobs</span>
               </h1>
               ...
               <div>
                   <a href="/register"
                       class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 hover:text-red-700 hover:border-red-700">Sign
                       Up to List a Job</a>
               </div>
           </div>
       </section>
